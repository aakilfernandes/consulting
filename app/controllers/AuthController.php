...
class AuthController extends \BaseController {
	...
	public function join(){
			...
			$user->save();
			Auth::login($user);
			return Redirect::to($user->profileUrl)->with('growlMessages',[['success','Welcome to Angulytics!']]);
	}
	...
	public function login(){
		...
		return Redirect::to($user->profileUrl)->with('growlMessages',[['success','Login successful']]);
	}
